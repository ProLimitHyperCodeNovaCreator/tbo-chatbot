"""
Mock trainer for testing without database
"""
import joblib
import numpy as np
...
# Use mock config and db
from mock_testing.config_mock import settings
...
async def train_model():
    """
    Train ML model with validation and metrics (mock version)
    ...
    try:
        ...
        # Fetch training data from mock
        rows = await mock_db.training_events.find_many()
